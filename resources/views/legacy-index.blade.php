		...
		layers: [
			...
			},
			{
				...
				paint: {
					...
					'line-color': [
						'case',
						['in', '"lbroads"=>"great"', ['coalesce', ['get', 'tags'], '']],
						'rgb(125,0,125)',
						['in', '"lbroads"=>"bicycle_undefined"', ['coalesce', ['get', 'tags'], '']],
						'rgb(255,0,0)',
						['in', '"lbroads"=>"bikelane"', ['coalesce', ['get', 'tags'], '']],
						'rgb(0,0,255)',
						['in', '"lbroads"=>"greatfoot"', ['coalesce', ['get', 'tags'], '']],
						'rgb(19,130,0)',
						['in', '"lbroads"=>"foot"', ['coalesce', ['get', 'tags'], '']],
						'rgb(40,252,3)',
						['in', '"lbroads"=>"undefined"', ['coalesce', ['get', 'tags'], '']],
						'rgb(0,0,0)',
						'rgb(0,0,0)'
					]
				},
